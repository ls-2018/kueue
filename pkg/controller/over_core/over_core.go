...
func SetupControllers(mgr ctrl.Manager, qManager *over_queue.Manager, cc *cache.Cache, cfg *configapi.Configuration) (string, error) {
	...
	if over_features.Enabled(over_features.HierarchicalCohorts) {
