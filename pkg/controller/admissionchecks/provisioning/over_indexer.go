...
func indexRequestsOwner(obj client.Object) []string {
	...
	return over_slices.Map(refs, func(r *metav1.OwnerReference) string { return r.Name })
}
...
func indexWorkloadsChecks(obj client.Object) []string {
	...
	return over_slices.Map(wl.Status.AdmissionChecks, func(c *kueue.AdmissionCheckState) string { return string(c.Name) })
}
...
func SetupIndexer(ctx context.Context, indexer client.FieldIndexer) error {
	...
	if err := indexer.IndexField(ctx, &kueue.AdmissionCheck{}, AdmissionCheckUsingConfigKey, over_admissioncheck.IndexerByConfigFunction(kueue.ProvisioningRequestControllerName, configGVK)); err != nil {
