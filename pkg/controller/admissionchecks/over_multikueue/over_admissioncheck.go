...
type multiKueueStoreHelper = over_admissioncheck.ConfigHelper[*kueue.MultiKueueConfig, kueue.MultiKueueConfig]

func newMultiKueueStoreHelper(c client.Client) (*multiKueueStoreHelper, error) {
	return over_admissioncheck.NewConfigHelper[*kueue.MultiKueueConfig](c)
}
