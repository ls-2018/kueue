...
// +kubebuilder:webhook:path=/mutate-apps-v1-statefulset,mutating=true,failurePolicy=fail,sideEffects=None,groups="apps",resources=statefulsets,verbs=create;update,versions=v1,name=mstatefulset.kb.io,admissionReviewVersions=v1,timeoutSeconds=30
...
func (wh *Webhook) Default(ctx context.Context, obj runtime.Object) error {
	...
	if suspend {
		...
		ss.Spec.Template.Labels[over_constants.ManagedByKueueLabelKey] = over_constants.ManagedByKueueLabelValue
...
// +kubebuilder:webhook:path=/validate-apps-v1-statefulset,mutating=false,failurePolicy=fail,sideEffects=None,groups="apps",resources=statefulsets,verbs=create;update,versions=v1,name=vstatefulset.kb.io,admissionReviewVersions=v1,timeoutSeconds=30
