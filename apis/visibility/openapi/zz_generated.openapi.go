...
func schema_kueue_apis_visibility_v1beta1_PendingWorkload(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PendingWorkload 是面向用户的待处理工作负载表示，用于汇总在集群队列中的相关位置信息。",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"metadata": {
						SchemaProps: spec.SchemaProps{
					...
					"priority": {
						SchemaProps: spec.SchemaProps{
							Description: "Priority 表示工作负载的优先级",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
					...
					"localQueueName": {
						SchemaProps: spec.SchemaProps{
							Description: "LocalQueueName 表示该工作负载提交到的 LocalQueue 的名称",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"positionInClusterQueue": {
						SchemaProps: spec.SchemaProps{
							Description: "PositionInClusterQueue 表示工作负载在 ClusterQueue 中的位置，从 0 开始",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
					...
					"positionInLocalQueue": {
						SchemaProps: spec.SchemaProps{
							Description: "PositionInLocalQueue 表示工作负载在 LocalQueue 中的位置，从 0 开始",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
...
func schema_kueue_apis_visibility_v1beta1_PendingWorkloadOptions(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PendingWorkloadOptions 是可见性查询中使用的查询参数",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"offset": {
						SchemaProps: spec.SchemaProps{
							Description: "Offset 表示应获取的第一个待处理工作负载的位置，从 0 开始。默认值为 0",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int64",
						},
					...
					"limit": {
						SchemaProps: spec.SchemaProps{
							Description: "Limit 表示应获取的待处理工作负载的最大数量。默认值为 1000",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
...
func schema_kueue_apis_visibility_v1beta1_PendingWorkloadsSummary(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PendingWorkloadsSummary 包含在查询上下文（LocalQueue 或 ClusterQueue 内）中的待处理工作负载列表。",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
